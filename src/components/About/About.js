...
import suntwist from '../../images/suntwist.jpeg';

export default class About extends Component {
  render() {
    return (
      <div className={styles.aboutme} style={{ backgroundImage: `url(${suntwist})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
      <div className={styles.content}>
        ...
        On weekends, I have fun playing electric guitar in my worship team and my band <i>SUNTWIST</i>. I enjoy attending local/large concerts
